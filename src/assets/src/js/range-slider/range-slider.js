...
$(".handles-range-slider").ionRangeSlider({
    type: "double",
    grid: true,
    min: 0,
    max: 100,
...
// Drag Range Slider 
$(".drag-range-slider").ionRangeSlider({
    type: "double",
    grid: true,
    min: 0,
    max: 100,
...
$(".primary-range-slider").ionRangeSlider({
    type: "double",
    grid: true,
    min: 0,
    max: 100,
...
$(".success-range-slider").ionRangeSlider({
    type: "double",
    grid: true,
    min: 0,
    max: 100,
...
// Danger Range Slider
$(".danger-range-slider").ionRangeSlider({
    type: "double",
    grid: true,
    min: 0,
    max: 100,
...
$(".warning-range-slider").ionRangeSlider({
    type: "double",
    grid: true,
    min: 0,
    max: 100,
...
// Info Range Slider
$(".info-range-slider").ionRangeSlider({
    type: "double",
    grid: true,
    min: 0,
    max: 100,
