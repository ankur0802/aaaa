var FullCalendar = (function(exports) {
    ...
    */
    ...
    StandardTheme.prototype.classes = {
        ...
        button: 'fc-button btn btn-light',
        buttonActive: 'active',
    };
    StandardTheme.prototype.baseIconClass = 'fc-icon';
    StandardTheme.prototype.iconClasses = {
        close: 'fc-icon-x',
        prev: 'bi bi-chevron-left fs-6',
        next: 'bi bi-chevron-right fs-6',
        prevYear: 'bi bi-chevron-double-left',
        nextYear: 'bi bi-chevron-double-right',
    };
    StandardTheme.prototype.rtlIconClasses = {
        prev: 'bi bi-chevron-right fs-6',
        next: 'bi bi-chevron-left fs-6',
        prevYear: 'bi bi-chevron-double-right',
        nextYear: 'bi bi-chevron-double-left',
    };
