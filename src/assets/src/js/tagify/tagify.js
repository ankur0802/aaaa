! function(t, e) {
    ...
    187: function(t, e, i) {
        t.exports = function() {
            ...
            const i = (t, e, i, s) => (t = "" + t, e = "" + e, s && (t = t.trim(), e = e.trim()), i ? t == e : t.toLowerCase() == e.toLowerCase());
            ...
            var g, c = () => /(?=.*chrome)(?=.*android)/i.test(navigator.userAgent),
                p = {
                    init() {
                    ...
                    show(t) {
                        ...
                        if (t = void 0 === t ? this.state.inputText : t, (!r || o || n.templates.dropdownItemNoMatch) && !1 !== n.dropdown.enable && !this.state.isLoading) {
                            if (clearTimeout(this.dropdownHide__bindEventsTimeout), this.suggestedListItems = this.dropdown.filterListItems.call(this, t), t && !this.suggestedListItems.length && (this.trigger("dropdown:noMatch", t), n.templates.dropdownItemNoMatch && (a = n.templates.dropdownItemNoMatch.call(this, {
                                    value: t
                                }))), !a) {
                                if (this.suggestedListItems.length) t && o && !this.state.editing.scope && !i(this.suggestedListItems[0].value, t) && this.suggestedListItems.unshift({
                                    value: t
                                });
                                else {
                                    if (!t || !o || this.state.editing.scope) return this.input.autocomplete.suggest.call(this), void this.dropdown.hide.call(this);
                                    this.suggestedListItems = [{
                                        value: t
                                    }]
                                }
                                s = "" + (l(e = this.suggestedListItems[0]) ? e.value : e), n.autoComplete && s && 0 == s.indexOf(t) && this.input.autocomplete.suggest.call(this, e)
                            }
                            this.dropdown.fill.call(this, a), n.dropdown.highlightFirst && this.dropdown.highlightOption.call(this, this.DOM.dropdown.content.children[0]), this.state.dropdown.visible || setTimeout(this.dropdown.events.binding.bind(this)), this.state.dropdown.visible = t || !0, this.state.dropdown.query = t, this.setStateSelection(), d || setTimeout(() => {
                    ...
                    filterListItems(t, e) {
                        var i, s, a, n, o, r = this.settings,
                            ...
                            u = d.searchKeys,
                            m = 0;
                        if (!t || !u.length) return (r.duplicates ? c : c.filter(t => !this.isTagDuplicate(l(t) ? t.value : t))).slice(0, p);
                        ...
                        for (o = d.caseSensitive ? "" + t : ("" + t).toLowerCase(); m < c.length; m++) {
                            ...
                            if (d.fuzzySearch && !e.exact ? (a = t.reduce((t, e) => t + " " + (i[e] || ""), "").toLowerCase(), d.accentedSearch && (a = h(a), o = h(o)), s = v(a, o)) : s = t.some(t => {
                                    var s = "" + (i[t] || "");
                                    return d.accentedSearch && (s = h(s), o = h(o)), d.caseSensitive || (s = s.toLowerCase()), e.exact ? s == o : 0 == s.indexOf(o)
                                }), n = !r.duplicates && this.isTagDuplicate(l(i) ? i.value : i), s && !n && p-- && g.push(i), 0 == p) break
                        }
                        return g
                    },
                    getMappedValue(t) {
                ...
                v = {
                    ...
                    callbacks: {
                        ...
                        onWindowKeyDown(t) {
                            ...
                            if (i.classList.contains(this.settings.classNames.tag) && this.DOM.scope.contains(document.activeElement)) switch (e = i.nextElementSibling, t.key) {
                                case "Backspace":
                            ...
                            if (this.trigger("keydown", {
                                ...
                                switch (t.key) {
                                    ...
                                    case "Backspace":
                                        ...
                                        var i, s, o, r = document.getSelection(),
                                            ...
                                            h = a(this.DOM.input.innerHTML),
                                            p = this.getTagElms();
                                        if ("edit" == this.settings.backspace && d) return i = 1 == r.anchorNode.nodeType ? null : r.anchorNode.previousElementSibling, setTimeout(this.editTag.bind(this), 0, i), void t.preventDefault();
                                        if (c() && d) return o = n(d), d.hasAttribute("readonly") || d.remove(), this.DOM.input.focus(), void setTimeout(() => {
                                            this.placeCaretAfterNode(o), this.DOM.input.click()
                                        });
                                        if ("BR" == r.anchorNode.nodeName) return;
                                        if ((l || d) && 1 == r.anchorNode.nodeType ? s = 0 == r.anchorOffset ? l ? p[0] : null : p[r.anchorOffset - 1] : l ? s = r.anchorNode.nextElementSibling : d && (s = d), 3 == r.anchorNode.nodeType && !r.anchorNode.nodeValue && r.anchorNode.previousElementSibling && t.preventDefault(), (d || l) && !this.settings.backspace) return void t.preventDefault();
                                        ...
                                        clearTimeout(g), g = setTimeout(() => {
                                            ...
                                            if (!c() && e.length >= h.length && i && !i.hasAttribute("readonly") && (this.removeTags(i), this.fixFirefoxLastTagNoCaret(), 2 == this.DOM.input.children.length && "BR" == this.DOM.input.children[1].tagName)) return this.DOM.input.innerHTML = "", this.value.length = 0, !0;
                        ...
                        onInput(t) {
                            ...
                            s.isValid = this.validateTag({
                                value: e
                            }), this.state.inputText != e && (this.input.set.call(this, e, !1), -1 != e.search(this.settings.delimiters) ? this.addTags(e) && this.input.set.call(this) : this.settings.dropdown.enabled >= 0 && this.dropdown[i ? "show" : "hide"].call(this, e), this.trigger("input", s))
                        },
                        onMixTagsInput(t) {
                            ...
                            if ("deleteContentBackward" == t.inputType && c() && this.events.callbacks.onKeydown.call(this, {
                                ...
                                }), u.childNodes.length && (m.insertNode(u), this.setRangeAtStartEnd(!1, u.lastChild)), p.length != g) return this.value = [].map.call(this.getTagElms(), t => this.tagData(t)), void this.update({
                        ...
                        onPaste(t) {
                            var e, i;
                            t.preventDefault(), this.settings.readonly || (e = t.clipboardData || window.clipboardData, i = e.getData("Text"), this.settings.hooks.beforePaste(t, {
                                tagify: this,
                                pastedText: i,
                                clipboardData: e
                            }).then(e => {
                                void 0 === e && (e = i), e && (this.injectAtCaret(e, window.getSelection().getRangeAt(0)), "mix" == this.settings.mode ? this.events.callbacks.onMixTagsInput.call(this, t) : this.addTags(this.DOM.input.textContent, !0))
                            }).catch(t => t))
                        },
                        onEditTagInput(t, e) {
                            ...
                            o || !0 !== t.originalIsValid || (r = !0), i.classList.toggle(this.settings.classNames.tagInvalid, !0 !== r), a.__isValid = r, i.title = !0 === r ? a.title || a.value : r, n.length >= this.settings.dropdown.enabled && (this.state.editing && (this.state.editing.value = n), this.dropdown.show.call(this, n)), this.trigger("edit:input", {
                                tag: i,
                                index: s,
                                data: d({}, this.value[s], {
                                    newValue: n
                        ...
                        onEditTagBlur(t) {
                            if (this.state.hasFocus || this.toggleFocusClass(), this.DOM.scope.contains(t)) {
                                var e, i = this.settings,
                                    ...
                                    o = s.innerHTML != s.__tagifyTagData.__originalHTML,
                                    r = this.validateTag({
                                        [i.tagTextProp]: a
                                    });
                                if (a)
                                    if (o) {
                                        if (e = this.getWhitelistItem(a) || d({}, n, {
                                                ...
                                                value: a,
                                                __isValid: r
                                            }), i.transformTag.call(this, e, n), !0 !== (r = this.validateTag({
            ...
            return f.prototype = {
                ...
                getAttributes(t) {
                    ...
                    var e, i, s = Object.keys(t),
                        a = "";
                    for (i = s.length; i--;) "__" != (e = s[i]).slice(0, 2) && "class" != e && t.hasOwnProperty(e) && void 0 !== t[e] && (a += " " + e + (void 0 !== t[e] ? `="${t[e]}"` : ""));
                    return a
                },
                setStateSelection() {
                ...
                loadOriginalValues(t) {
                    var e, i = this.settings;
                    if (void 0 === t && (t = i.mixMode.integrated ? this.DOM.input.textContent : this.DOM.originalInput.value), this.removeAllTags({
                            withoutChangeEvent: !0
                        }), t)
                ...
                editTag(t, e) {
                    ...
                    if (a) {
                        ...
                        })), a.addEventListener("input", r.onEditTagInput.bind(this, a)), a.addEventListener("keydown", e => r.onEditTagkeydown.call(this, e, t)), a.focus(), this.setRangeAtStartEnd(!1, a), e.skipValidation || (h = this.editTagToggleValidity(t, o.value)), a.originalIsValid = h, this.trigger("edit:start", {
                            tag: t,
                            index: n,
                            data: o,
                            isValid: h
                ...
                onEditTagDone(t, e) {
                    ...
                    this.trigger("edit:beforeUpdate", i, {
                        cloneData: !1
                    }), this.state.editing = !1, delete e.__originalData, delete e.__originalHTML, t && e[this.settings.tagTextProp] ? (this.editTagToggleValidity(t), t = this.replaceTag(t, e), this.settings.a11y.focusableTags && t.focus()) : t && this.removeTags(t), this.trigger("edit:updated", i), this.dropdown.hide.call(this), this.settings.keepInvalidTags && this.reCheckInvalidTags()
                },
                replaceTag(t, e) {
                ...
                input: {
                    set(t = "", e = !0) {
                        ...
                        this.state.inputText = t, e && (this.DOM.input.innerHTML = o("" + t)), !t && i && this.dropdown.hide.bind(this), this.input.autocomplete.suggest.call(this), this.input.validate.call(this)
                    },
                    validate() {
                ...
                getWhitelistItem(t, e, s) {
                    ...
                    return (s = s || n.whitelist).some(s => {
                        ...
                        if (i(o, t, n.dropdown.caseSensitive, n.trim)) return a = "string" == typeof s ? {
                            value: s
                        } : s, !0
                    }), a || "value" != e || "value" == n.tagTextProp || (a = this.getWhitelistItem(t, n.tagTextProp, s)), a
                },
                validateTag(t) {
                    var e = this.settings,
                ...
                addTags(t, e, i = this.settings.skipInvalid) {
                    ...
                    return t && 0 != t.length ? (t = this.normalizeTags(t), "mix" == a.mode ? this.addMixTags(t) : ("select" == a.mode && (e = !1), this.DOM.input.removeAttribute("style"), t.forEach(t => {
                        ...
                        if (t.readonly && (o["aria-readonly"] = !0), e = this.createTagElem(t, o), s.push(e), "select" == a.mode) return this.selectTag(e, t);
                        n.appendChild(e), t.__isValid && !0 === t.__isValid ? (this.value.push(t), this.update(), this.trigger("add", {
                            tag: e,
                ...
                createTagElem(i, s) {
                    ...
                    }(a = this.parseTemplate("tag", [n])), this.tagData(a, i), a
                },
                reCheckInvalidTags() {
                    var t = this.settings;
                ...
                update(t) {
                    ...
                    this.settings.mixMode.integrated || (e.value = this.getInputValue()), this.postUpdate(), !i && this.state.loadedOriginalValues && this.triggerChangeEvent()
                },
                getInputValue() {
                ...
                getCleanValue(t) {
                    return e = t || this.value, i = this.dataProps, e && r(e) && e.map(t => s(t, i));
                    var e, i
                },
