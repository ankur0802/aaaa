...
! function() {
    ...
    if (t) {
        ...
        const i = L.marker([48.817152, 2.455], {
            draggable: "true"
        }).addTo(t);
        i.bindPopup("<b>You're here!</b>").openPopup(), L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", {
            attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>',
            maxZoom: 18
        }).addTo(t)
    }
    if (document.getElementById("userLocation")) {
        const n = L.map("userLocation").setView([42.35, -71.08], 10);
        n.locate({
            setView: !0,
            maxZoom: 16
        }), n.on("locationfound", function(e) {
            var t = e.accuracy;
            L.marker(e.latlng).addTo(n).bindPopup("You are somewhere around " + t + " meters from this point").openPopup(), L.circle(e.latlng, t).addTo(n)
